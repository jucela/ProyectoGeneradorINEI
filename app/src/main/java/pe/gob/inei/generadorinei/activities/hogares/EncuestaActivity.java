...
public class EncuestaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(EncuestaActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(EncuestaActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, Constants.REQUEST_PERMISSION_WRITE_EXTERNAL_STORAGE);
        } else {
            appController.setDB();
        }
    }
            ...
            if (i<preguntas.size()) {
                ...
                switch (tipo) {
                    case TipoComponente.FORMULARIO:
                        ...
                        //FormularioFragment formularioFragment = new FormularioFragment(formulario, formularios, EncuestaActivity.this, idVivienda);
                        FormularioFragment formularioFragment = new FormularioFragment(formulario, formularios, EncuestaActivity.this, idVivienda, numero_hogar, numero_residente, tipo_guardado,tabla_guardado);
                    ...
                    case TipoComponente.EDITTEXT:
                        ...
                        //EditTextFragment editTextFragment = new EditTextFragment(pEditText, spEditTexts, EncuestaActivity.this, encuestado);
                        EditTextFragment editTextFragment = new EditTextFragment(pEditText, spEditTexts, EncuestaActivity.this, idVivienda, numero_hogar, numero_residente, tipo_guardado,tabla_guardado);
                    ...
                    case TipoComponente.CHECKBOX:
                        ...
                        //CheckBoxFragment checkBoxFragment = new CheckBoxFragment(pCheckbox, spCheckBoxes, EncuestaActivity.this, encuestado);
                        CheckBoxFragment checkBoxFragment = new CheckBoxFragment(pCheckbox, spCheckBoxes, EncuestaActivity.this, idVivienda, numero_hogar, numero_residente, tipo_guardado,tabla_guardado);
                    ...
                    case TipoComponente.RADIO:
                        ...
                        //RadioFragment radioFragment = new RadioFragment(pRadio, spRadios, EncuestaActivity.this, encuestado);
                        RadioFragment radioFragment = new RadioFragment(pRadio, spRadios, EncuestaActivity.this, idVivienda, numero_hogar, numero_residente, tipo_guardado,tabla_guardado);
                        fragmentComponente = radioFragment;
                        break;
                    case TipoComponente.VISITAS:
                        appController = (AppController) getApplication();
                        daoSession = appController.getDaoSession();
                        FragmentVisitasEncuestador visitasFragment = new FragmentVisitasEncuestador(idVivienda, numero_hogar, EncuestaActivity.this, appController);
                        fragmentComponente = visitasFragment;
                        break;
                    case TipoComponente.FUNCIONARIOS:
                        appController = (AppController) getApplication();
                        //FuncionariosFragment funcionariosFragment = new FuncionariosFragment(idVivienda, numero_hogar, EncuestaActivity.this, appController);
                        FuncionariosFragment funcionariosFragment = new FuncionariosFragment(EncuestaActivity.this, appController, idVivienda, numero_hogar, numero_residente, tipo_guardado,tabla_guardado);
                        fragmentComponente = funcionariosFragment;
                        break;
                    case TipoComponente.RESIDENTES:
                        appController = (AppController) getApplication();
                        daoSession = appController.getDaoSession();
                        ResidentesFragment residentesFragment = new ResidentesFragment(idVivienda, numero_hogar, EncuestaActivity.this, appController);
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("¿Está seguro que desea volver a Hogares? (no se guardaran los cambios)")
                .setTitle("Aviso")
                .setCancelable(false)
