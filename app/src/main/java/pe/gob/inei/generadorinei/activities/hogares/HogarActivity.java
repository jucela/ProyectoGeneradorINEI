...
public class HogarActivity extends AppCompatActivity {
    ...
    final String TIPO_ACTIVIDAD = TipoActividad.ACTIVIDAD_HOGAR;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numeroPaginasTotal = daoEncuesta.getNroPaginas(TipoActividad.ACTIVIDAD_HOGAR);
        conectarVistas();
        ...
        if (ContextCompat.checkSelfPermission(HogarActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(HogarActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, Constants.REQUEST_PERMISSION_WRITE_EXTERNAL_STORAGE);
        } else {
            appController.setDB();
        }
    ...
    public void setearPagina(int numeroPagina) {
        Pagina pagina = daoEncuesta.getPagina(numeroPagina+"",TipoActividad.ACTIVIDAD_HOGAR);
            ...
            if (i<preguntas.size()) {
                ...
                switch (tipo) {
                    case TipoComponente.FORMULARIO:
                        ...
                        FormularioFragment formularioFragment = new FormularioFragment(formulario, formularios, HogarActivity.this, idVivienda, numero_hogar, "", tipo_guardado,tabla_guardado);
                    ...
                    case TipoComponente.EDITTEXT:
                        ...
                        EditTextFragment editTextFragment = new EditTextFragment(pEditText, spEditTexts, HogarActivity.this, idVivienda, numero_hogar, "", tipo_guardado,tabla_guardado);
                    ...
                    case TipoComponente.CHECKBOX:
                        ...
                        CheckBoxFragment checkBoxFragment = new CheckBoxFragment(pCheckbox, spCheckBoxes, HogarActivity.this, idVivienda, numero_hogar, "", tipo_guardado,tabla_guardado);
                    ...
                    case TipoComponente.RADIO:
                        ...
                        RadioFragment radioFragment = new RadioFragment(pRadio, spRadios, HogarActivity.this, idVivienda, numero_hogar, "", tipo_guardado,tabla_guardado);
                        fragmentComponente = radioFragment;
                        break;
                    case TipoComponente.VISITAS:
                        appController = (AppController) getApplication();
                        daoSession = appController.getDaoSession();
                        FragmentVisitasEncuestador visitasFragment = new FragmentVisitasEncuestador(idVivienda, numero_hogar,HogarActivity.this, appController);
                    ...
                    case TipoComponente.FUNCIONARIOS:
                        ...
                        FuncionariosFragment funcionariosFragment = new FuncionariosFragment(HogarActivity.this, appController, idVivienda, numero_hogar, "", tipo_guardado,tabla_guardado);
                        fragmentComponente = funcionariosFragment;
                        break;
                    case TipoComponente.RESIDENTES:
                        appController = (AppController) getApplication();
                        daoSession = appController.getDaoSession();
                        ResidentesFragment residentesFragment = new ResidentesFragment(idVivienda, numero_hogar,HogarActivity.this, appController);
    ...
    private void configurarListaExpandible() {
        ...
        expListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ArrayList<Modulo> modulos = daoEncuesta.getAllModulos(TipoActividad.ACTIVIDAD_HOGAR);
    ...
    public void setNombreSeccion(int nPagina, int direccion) {
        ...
        String idModulo = daoEncuesta.getPagina(numeroDePagina + "",TipoActividad.ACTIVIDAD_HOGAR).getModulo();
        Log.e("idModulo",""+idModulo);
        Log.e("idModuloActual",""+idModuloActual);
        if (!idModulo.equals(idModuloActual)) {
            nombreSeccion = daoEncuesta.getModulo(idModulo,TipoActividad.ACTIVIDAD_HOGAR).getTitulo();
            FragmentManager fragmentManager = getSupportFragmentManager();
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            if (direccion > 0) {
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("¿Está seguro que desea volver a la Caratula? (no se guardaran los cambios)")
                .setTitle("Aviso")
                .setCancelable(false)
